  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          <h5>Selamat Datang <strong>Operator Puskesmas</strong>. Silahkan pilih halaman yang ingin ditampilkan.</h5>
        </div>
      </div>
      <div class="row gx-5">
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <h3>Nomor Antrian</h3>
              <p class="mb-4">Halaman Nomor Antrian digunakan operator untuk mengambil nomor antrian.</p>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <p class="mb-4">Halaman Panggilan Antrian digunakan operator untuk memanggil antrian pengunjung.</p>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2021 - <a href="#" target="_blank" class="text-danger text-decoration-none">Beni Basuki</a>. All rights reserved.
      </div>
    </div>
  </footer>
